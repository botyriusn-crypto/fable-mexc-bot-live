...
export const botConfig = pgTable("bot_config", {
  ...
  trendRiderPullbackAtr: doublePrecision("trend_rider_pullback_atr").notNull().default(0.5),
  trendRiderMinTrendAge: integer("trend_rider_min_trend_age").notNull().default(2),
  trendRiderChandelierMult: doublePrecision("trend_rider_chandelier_mult").notNull().default(2.5),
