...
console.log(`Clean longs with entryTime: ${longs.length}\n`)
...
const stopAtrMults = [0.5, 1.0, 1.5, 2.0, 2.5, 3.0]
const tpSlRatios = [1, 1.5, 2, 2.5, 3, 4, 5, 6]
